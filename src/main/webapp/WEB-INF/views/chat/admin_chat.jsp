...
<body>
    ...
    <div id="ct">
        <div class="ct_wrap">
            ...
            <h2 style="text-align: center;">${reqid }와의 채팅</h2>
           <div class="chat_box">
           ...
           <div style="width: 500px; margin: 20px auto; text-align: center;">
           	<button type="button" onclick="location.href='${path}/chat/chatList'">비우기</button>
            <button type="button" onclick="location.href='${path}/chat/chatList'">목록</button>
           </div>
        </div>
...
$.ajax({				
	url : "${path }/chat/json?reqid=${reqid }", // MemberJSONCtrl의 JSONObject 값을 가져옴
