     ...
     <div id="ct">
        <div class="page_warp">
            ...
            <div class="board">
                ...
                <form action="${path }/board/qna_search" method="POST">
                ...
                <button onclick="location.href = '${path}/board/WriteForm?type=4'" style="float: right;">추가</button>
                    <table>
                        <colgroup>
                            <col style="width:10%;">
                            <col>
                        ...
                        <tbody>
                            ...
                            <tr class="even">
                                ...
                                <td class="td_subject" style="padding-left:0px">
                                    <div class="bo_tit">
                                        <a href="${path }/board/more_qna?no=${DTO.no}">${DTO.tit } 
