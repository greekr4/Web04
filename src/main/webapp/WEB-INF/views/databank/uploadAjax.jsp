...
$(document).ready(function () {
	...
	$(".fileDrop").on("drop", function(event){
		...
		$.ajax({
			url: '${path }/data_board/uploadAjax.do',
			data: formData,
			dataType: 'text',
			processData: false,
			contentType: false,
			...
			success: function(data){
				...
				if(checkImageType(data)){
					str = "<div>"
						+ "<a href='${path }/data_board/displayFile.do?fileName=" + getImageLink(data) + "'>"
						+ "<img src='${path }/data_board/displayFile.do?fileName=" + data + "'/>"
						+ "</a>"
	...
	$(".uploadedList").on("click", "span", function(event){
		...
		$.ajax({
			url: "${path }/data_board/deleteFile.do",
			type: "post",
